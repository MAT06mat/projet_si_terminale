...
title = Rubiks Cube Master

# (str) Package name
package.name = rcm

# (str) Package domain (needed for android/ios packaging)
package.domain = com.matthieufelten.rcm
...
source.exclude_exts = spec, md, cff, gitignore
...
requirements = python3==3.11.2,hostpython3==3.11.2,kivy,tqdm,kociemba,Pillow,matplotlib,https://github.com/kivymd/KivyMD/archive/master.zip,materialyoucolor,exceptiongroup,asyncgui,asynckivy
...
android.permissions = android.permission.BLUETOOTH, android.permission.BLUETOOTH_ADMIN, android.permission.BLUETOOTH_CONNECT, android.permission.WRITE_EXTERNAL_STORAGE
